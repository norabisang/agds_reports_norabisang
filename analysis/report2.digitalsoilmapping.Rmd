...
Comparing the two models, the Untuned Model performs better across all RF-default metrics. It is roughly 1.5% more accurate. That the 95% CIs overlap (72.7%–84.4% for the untuned model and 71.1%-83.1%) tells us that though the untuned model is better, both models perform similarly wee and are stable and reliable. 
